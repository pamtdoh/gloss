...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: "notNeeded", keys: ["1"], shown: "1", section: "Decide", label: "Quick annotate: not needed" },
  { id: "simplify", keys: ["2"], shown: "2", section: "Decide", label: "Quick annotate: simplify" },
  { id: "defer", keys: ["3"], shown: "3", section: "Decide", label: "Quick annotate: defer" },
  ...
  { id: "select", keys: ["x"], shown: "x", section: "Decide", label: "Select fact for bulk quick-annotate" },
  ...
  { id: "undo", keys: ["u"], shown: "u", section: "Items", label: "Undo last annotation" },
];
