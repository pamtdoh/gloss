...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: "notNeeded", keys: ["1"], shown: "1", section: "Decide", label: "Stamp: not needed" },
  { id: "simplify", keys: ["2"], shown: "2", section: "Decide", label: "Stamp: simplify" },
  { id: "defer", keys: ["3"], shown: "3", section: "Decide", label: "Stamp: defer" },
  ...
  { id: "select", keys: ["x"], shown: "x", section: "Decide", label: "Select fact for bulk stamps" },
